...
class PersonIntel(BaseModel):
    ...
    facts: List[str] = Field(description="Interseting facts about the person")
...
person_intel_parsor: PydanticOutputParser = PydanticOutputParser(pydantic_object=PersonIntel)
